...
У цьому розділі описано розробку та досвід роботи з тренажером для сталепрокатного цеху. Метою навчання є те, як замінити валки, що зазвичай контролюється електронною системою, але в певних виняткових ситуаціях має виконуватися операторами або обслуговуючим персоналом без автоматичного контролю послідовності. Фактична машина не доступна для навчання, оскільки виробництво повністю автоматизоване та працює цілодобово. Цей тренажер для навчання операторів (OTS) замінює функціональність машини в циклі копією електронної системи керування (hardware-in-the-loop, HIL). Симуляція використовується для навчання операторів і обслуговуючого персоналу. Мотивацією для розробки симулятора було забезпечення належної підготовки персоналу без необхідності переривати виробничу рутину машини.
...
Вступ описує основні міркування, які були необхідні для успішного проекту розробки. У другому розділі обговорюється статус моделювання на підприємствах промислового виробництва, де зазначається, що моделювання має швидко зростаюче значення в цій галузі. Третій розділ представляє деталі дизайну симулятора та деякі цікаві особливості, які були виявлені під час проекту. Нарешті, наводиться досвід, набутий протягом кількох місяців.
