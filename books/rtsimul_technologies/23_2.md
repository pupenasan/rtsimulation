...
nonlinear elements. In each case, real-time execution was achieved with very accurate results. The modeling concepts in these models included the following:
...
a.   Performing a fixed-cost simulation requires setting the number of iterations to prevent overruns. This is done by selecting the “Use fixed-cost
